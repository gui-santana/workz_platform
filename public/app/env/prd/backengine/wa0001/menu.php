...
<div id="divForm" class="large-12 medium-12 small-12 cm-pad-20 centered">
	...
	<div class="w-shadow w-rounded-15">
		...
		<div class="large-12 medium-12 small-12 text-ellipsis display-center-general-container background-white border-t-input">
			...
			<input type="time" id="time" name="time" class="float-left border-none large-10 medium-10 small-8 cm-pad-10 cm-pad-5-l"
			...
			function selectUsers(team){
				...
				if(team > 0){
					...
					waitForElm('#teamUsers').then((elm) => {
						goPost('core/backengine/wa0001/user_cmp.php?func=1-1<?= ($modoEdicao) ? '&task='.$dados['id'] : '' ?>', 'teamUsers', team, '');
						$('#teamUsers').select2({
		...
		<div class="large-12 medium-12 small-12 text-ellipsis display-center-general-container background-white border-t-input w-rounded-15-b">
			...
			<input class="float-left border-none large-10 medium-10 small-8 cm-pad-5-l background-white required" style="height: 45px" id="cl" name="cl" type="color"></input>
		</div>			
		<?php 
		}
		?>		
	...
	<div class="w-shadow w-rounded-15 cm-mg-20 cm-mg-0-h">		
		<div class="large-12 medium-12 small-12 cm-pad-15 cm-pad-0-t text-ellipsis background-white w-rounded-15">					
		<div class="float-left large-12 medium-12 small-12 text-ellipsis display-center-general-container" style="height: 45px">Competências</div>										
		<?php			
	...
	?>	
	<div onclick="formValidator2('divForm', 'core/backengine/wa0001/<?= $formAction ?>?action=<?= $action ?>&type=<?= $tipo ?>', 'main-content');" class="text-ellipsis cm-pad-10 large-12 medium-12 small-12 w-color-bl-to-or pointer w-bkg-wh-to-gr w-shadow w-rounded-15 cm-mg-20-t">
...
<div id="new" class="large-12 medium-12 small-12 cm-pad-20 centered">  
	<div id="divForm" class="w-shadow w-rounded-15">		
		...
		<div class="large-12 medium-12 small-12 text-ellipsis display-center-general-container text-ellipsis background-white border-t-input">										
			...
			include('user_cmp.php');
			?>
			<select name="cm" id="cm" class="float-left border-none large-10 medium-10 small-8 required" style="height: 45px" onchange="goPost('core/backengine/wa0001/user_cmp.php?func=5-1', 'teamTasks', this.value, '')">
	...
	<div onclick="formValidator2('divForm', 'core/backengine/wa0001/folder.php?action=include&type=<?= $tipo ?>', 'main-content');" class="text-ellipsis cm-pad-10 large-12 medium-12 small-12 w-color-bl-to-or pointer w-bkg-wh-to-gr w-shadow w-rounded-15 cm-mg-20-t">
		<span class="fa-stack orange" style="vertical-align: middle;">
			<i class="fas fa-circle fa-stack-2x light-gray"></i>
			<i class="fas fa-save fa-stack-1x fa-inverse dark"></i>					
		</span>						
