	...
	<div class="w-rounded-20 cm-pad-5 large-10 medium-12 small-12 w-modal-shadow text-center fs-f background-white display-center-general-container centered overflow-x-auto">
		<div class="centered large-6 medium-6 small-12 js-flickity" data-flickity-options='{ "groupCells": true, "cellAlign": "center", "imagesLoaded": true, "prevNextButtons": false, "pageDots": false, "fullscreen": false }'>
			<div class="float-left text-center cm-pad-15 line-height-a w-color-gr-to-gr">
				<i class="fas fa-tasks fs-g pointer cm-pad-5-t" onclick="goTo('env/<?= $env ?>/backengine/wa0001/main-content.php', 'main-content', '0', ''); resetCounter();"></i><br/>
				<a class="fs-a">Tarefas</a>
			</div>							
			<div class="float-left text-center cm-pad-15 line-height-a w-color-gr-to-gr">					
				<div onclick=" goTo('env/<?= $env ?>/backengine/wa0001/main-content.php', 'main-content', '0', 'folders'); resetCounter();" class="pointer cm-pad-5-t">
			...
			<div class="float-left text-center cm-pad-15 line-height-a w-color-gr-to-gr">
				<i class="fas fa-gift fs-g pointer cm-pad-5-t" onclick="goTo('env/<?= $env ?>/backengine/wa0001/main-content.php', 'main-content', '0', ''); resetCounter();"></i><br/>
				<a class="fs-a">Recompensas</a>
			</div>
			<div class="float-left text-center cm-pad-15 line-height-a w-color-gr-to-gr">
				<i class="fas fa-star fs-g pointer cm-pad-5-t" onclick="goTo('env/<?= $env ?>/backengine/wa0001/main-content.php', 'main-content', '0', ''); resetCounter();"></i><br/>
				<a class="fs-a">Desafios</a>
			</div>
			<div class="float-left text-center cm-pad-15 line-height-a w-color-gr-to-gr">
				<i class="fas fa-award fs-g pointer cm-pad-5-t" onclick="goTo('env/<?= $env ?>/backengine/wa0001/main-content.php', 'main-content', '0', ''); resetCounter();"></i><br/>
				<a class="fs-a">Ranking</a>
			</div>
			<div class="float-left text-center cm-pad-15 line-height-a w-color-gr-to-gr">
				<i class="fas fa-database fs-g pointer cm-pad-5-t" onclick="goTo('env/<?= $env ?>/backengine/wa0001/main-content.php', 'main-content', '0', 'regs'); resetCounter();"></i><br/>
...
function appOptions() {
    const optionsHTML = '<div class="w-shadow background-white w-rounded-15">' +
			...
			createOption("env/<?= $env ?>/backengine/wa0001/menu.php", "config", 3, "Nova Rotina", "fa-plus", true) +
            createOption("env/<?= $env ?>/backengine/wa0001/menu.php", "config", 4, "Nova Recompensa", "fa-gift", true) +
			createOption("env/<?= $env ?>/backengine/wa0001/menu.php", "config", 5, "Novo Desafio", "fa-star", true) +
            createOption("env/<?= $env ?>/backengine/wa0001/menu.php", "config", 6, "Carregar E-mails", "fa-envelope-open", true, false, true) +
        '</div>';        
