...
if((count($tskb) > 0) && ($tskd = search('app', 'wa0008_events', 'dt', "el = '".$tskr['id']."' AND ap = '1'"))){
	...
	<div id="folder-root" class="row large-10 medium-12 small-12 position-relative centered">
		...
		<div class="cm-mg-15-t">
			<div class="large-12 medium-12 small-12 display-center-general-container">				
				<div class="float-left fs-g height-100 font-weight-500 text-ellipsis large-10 medium-8 small-6 orange"><?= $tskr['tt'] ?></div>			
				...
				<div class="float-left large-2 mediun-4 small-6 text-right">
					...
					if($tskr['us'] == $_SESSION['wz'] || in_array($tskr['cm'], $userEntities['teams_manager'])){
						...
						if($tskr['st'] <> 2){
						?>					
						<span onclick="wAlert('env/<?= $env ?>/backengine/wa0001/folder.php', 'folder-root', 1, '<?= $tskr['tg'].'|'.$tskr['id']; ?>', 'Deseja excluir permanentemente esta tarefa?', 'Tarefa excluída com sucesso.', 'A tarefa não foi excluída.');" class="fa-stack w-color-gr-to-gr pointer" style="vertical-align: middle;" title="Excluir permanentemente esta tarefa">
					...
					?>
					<span onclick="goTo('env/<?= $env ?>/backengine/wa0001/folder.php', 'folder-root', 1, '<?= $tskr['tg'] ?>'); resetCounter();" class="fa-stack w-color-gr-to-gr pointer" style="vertical-align: middle;" title="Abrir a pasta da tarefa">
						<i class="fas fa-circle fa-stack-2x"></i>
			...
			<div class="cm-pad-15 cm-mg-25-t cm-mg-0-h large-12 medium-12 small-12 break-word w-rounded-15 w-shadow-1 background-white-transparent-75 backdrop-blur">
				<?php				
				...
				<div class="large-12 medium-12 small-12">			
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Editado por</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">
							<a target="_blank" class="pointer" href="https://workz.com.br/<?= $creator['un'] == '' ? '?profile='.$creator['id'] : $creator['un']; ?>"><?= $creator['tt']; ?></a>
						</div>
						<div class="clear"></div>
					</div>
					<?php
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Pasta</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">									
							<?= (!empty($tga[0]['cl'])) ? '<i class="fas fa-bookmark" style="color: '.$tga[0]['cl'].'"></i> ' : '' ?><a><?= $tga[0]['tt'] ?></a>									
						</div>
						<div class="clear"></div>
					</div>
					<?php				
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Equipe</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">						
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Atribuído a</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">
							<?php
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Observações</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">								
							<?= nl2br($tskr['ds']) ?>								
						</div>
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Status</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">
							<?= $statuses[$tskr['st']] ?>
						</div>
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Frequência</label>
						</div>																				
						<div class="large-9 medium-9 small-12 float-right">
					...
					<div class="large-12 medium-12 small-12 cm-mg-20-b">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500 cm-mg-5-b">Prazo final</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right">
					...
					<div class="large-12 medium-12 small-12">
						<div class="large-3 medium-3 small-12 float-left cm-pad-20-r">
							<label class="font-weight-500">Subtarefas</label>
						</div>
						<div class="large-9 medium-9 small-12 float-right orange">
						<?php									
						...
						foreach($steps as $key => $step){											
							...
							?>
							<label for="stepckb<?= $key ?>">
							<div class="cm-mg-5-t large-12 medium-12 small-12 w-shadow-1 cm-pad-10 w-rounded-15 background-white-transparent-50 display-center-general-container">
								...
								<a class="cm-mg-5-l"><?= (!empty($step_date)) ? ' <strong class="orange">'.date('d/m/Y H:i', strtotime($step_date)).' | </strong>' : '' ?> <?= str_replace('\'', '', $step_desc) ?></a>
							</div>
							</label>
							<?php										
						}									
					...
					(function () {
						...
						goTo('env/<?= $env ?>/backengine/wa0001/task_progress.php', 'task_progress', '0', '<?= $tskr['id'] ?>');
						goTo('env/<?= $env ?>/backengine/wa0001/task_timeline.php', 'task_timeline', '0', '<?= $tskr['id'] ?>');					
					})();
					</script>						
				</div>									
			</div>
		...
		//EDITOR DE TEXTO
		?>
		<div class="large-12 medium-12 small-12 position-relative centered background-white w-shadow-1 w-rounded-15 cm-pad-15 cm-mg-25-t">					
			<div>
				...
				<div id="editContainer" class="large-12 medium-12 small-12 overflow-auto text-right background-white cm-mg-10-t">
					<div id="textBox" contenteditable="true" class="required float-left large-12 medium-12 small-12 text-left cm-pad-20 border-like-input w-rounded-15 position-relative"></div>					
					<div class="clear"></div>
				</div>
		...
		?>		
		<div id="task_timeline" class="large-12 medium-12 small-12 cm-mg-25-t w-task-tl-timeline"></div>
	</div>
	<?php			
}else{
