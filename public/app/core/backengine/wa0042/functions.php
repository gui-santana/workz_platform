<?php 
	...
	// connect to database
	$db =  mysqli_connect('127.0.0.1', 'u796300692_apps', '?B8XurkpA3', 'u796300692_apps');
	...
	function getUserById($id)
	{
		...
		$query = "SELECT * FROM wa0042_users WHERE id=" . $id;
	...
	function login()
	{
		...
		if (count($errors) == 0)
		{
			...
			$query = "SELECT * FROM wa0042_users WHERE username='$username' AND password='$password' LIMIT 1";
	...
	{
		global $db;		
		$query = "SELECT * FROM wa0042_users";
		$result = mysqli_query($db, $query);
	...
	function getAllMessages()
	{
		global $db;
		$myId	= $_SESSION['user']['id'];
		$query  = "SELECT * FROM wa0042_message WHERE recvId='$myId' OR sender='$myId'";
	...
	function checkNewMessage()
	{
		...
		$new_exists = false;		
		$query = "SELECT * FROM wa0042_last_seen WHERE user_id ='$myId'";
		$result = mysqli_query($db, $query) or die (mysqli_error($db));
	...
	function getUserByIdRow($myId)
	{
		...
		$query = "SELECT * FROM wa0042_users WHERE id='$myId' LIMIT 1";		
		$result = mysqli_query($db, $query) or die (mysqli_error($db));
	...
	function returnLastMessage($messageLastId)
	{
		...
		$query = "SELECT * FROM wa0042_users WHERE id='$messageLastId' LIMIT 1";		
		$result = mysqli_query($db, $query) or die (mysqli_error($db));
		...
		function latestMessage($messageId)
	{
		...
		$query = "SELECT * FROM wa0042_message WHERE recvId='$myId' AND id>'$messageId' ORDER BY time desc LIMIT 1";
	...
	{	
		...
		$query = "SELECT * FROM wa0042_message WHERE recvId='$myId' AND status = 1 ORDER BY time asc";		
		$result = mysqli_query($db, $query) or die (mysqli_error($db));
	...
	function updateLastSeen()
	{
		...
		$query = "SELECT * FROM wa0042_message WHERE recvId='$myId' ORDER BY time desc LIMIT 1";
	...
	function getLastUser()
	{
		...
		$query = "SELECT * FROM wa0042_last_seen WHERE user_id ='$myId' ORDER BY id desc LIMIT 1";
		$result = mysqli_query($db, $query) or die (mysqli_error($db));
