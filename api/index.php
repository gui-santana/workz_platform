...
$router->add('POST', '/api/change-email', [GeneralController::class, 'changeEmail'], [AuthMiddleware::class, 'handle']);
// Rota para alterar a senha
$router->add('POST', '/api/change-password', [GeneralController::class, 'changePassword'], [AuthMiddleware::class, 'handle']);
...
(require_once __DIR__ . '/routes/payments_routes.php')($router);
// Assinaturas (Preapproval/Plan)
(require_once __DIR__ . '/routes/subscriptions_routes.php')($router);
// Faturamento (Billing)
(require_once __DIR__ . '/routes/billing_routes.php')($router);
